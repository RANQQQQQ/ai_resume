...
A dependency-free, bilingual horizontal portfolio resume built from `HTML_Resume_Agent_Brief_May.md`.

Navigate with the left/right controls, arrow keys, mouse wheel or a horizontal swipe. The document itself never scrolls vertically; longer experience is distributed across focused pages.
